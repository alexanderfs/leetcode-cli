...
export function getObsidianVaultPath(): string { return conf.get('obsidianVaultPath') as string; }
...
export function setObsidianVaultPath(p: string): void { conf.set('obsidianVaultPath', p); }
